...
treatment = st.selectbox("Type de traitement :", ["Opt-in partenaire (OPT)", "Tirages gagnants (GAG)"])
nb_gagnants = st.number_input("🎯 Nombre de gagnants à tirer (pour GAG uniquement)", min_value=1, step=1, value=10) if treatment.startswith("Tirages") else None  # GAG à venir
